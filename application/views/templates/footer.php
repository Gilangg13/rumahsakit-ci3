<!-- Footer -->
<footer class="sticky-footer fixed-bottom bg-white p-2">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; PrimaMedika <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- Fontawesome -->
<script src="https://kit.fontawesome.com/e799cf9782.js" crossorigin="anonymous"></script>
